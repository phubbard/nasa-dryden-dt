...
public class SBDMessage {
	...
	// Should the payload be interpreted as binary data?
	 ...
	 * -----------------------------------
	 * 04/09/2010	JPW		Created
	 * 10/26/2011	JPW		Add bBinaryPayloadI argument
	 *
	 */
	public SBDMessage(BufferedInputStream bisI, boolean bBinaryPayloadI) throws IOException {
	...
	public void parse() throws Exception {
		...
		while(bais.available() > 0) {
			...
			case 0x02:
				...
				try {
					payloadIE = new MOPayloadIE(idB[0],bais,bBinaryPayload);
				} catch (Exception e) {
