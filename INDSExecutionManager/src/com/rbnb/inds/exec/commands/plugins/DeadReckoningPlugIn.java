...
/**
  ...
  */
public class DeadReckoningPlugIn extends DtPlugIn
{
	public DeadReckoningPlugIn(Attributes attr)
		throws IOException
	{
		super("DeadReckoningPlugIn", attr);
		
		String late = attr.getValue("maxLatency_sec");
		if (late != null) addArguments("-m", late);
	}
}
