 ...
 * output/downstream source's cache and archive settings will be set to match
 * those settings of the original/upstream source.
 *
 ...
 * source in a sleepy loop for up to 10 minutes.
 *
